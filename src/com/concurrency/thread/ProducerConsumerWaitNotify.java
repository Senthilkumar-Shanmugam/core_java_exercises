...
class ProducerT implements Runnable {
    ...
    public ProducerT(List<Integer> sharedQueue) {
...
class ConsumerT implements Runnable {
    private List<Integer> sharedQueue;
    public ConsumerT(List<Integer> sharedQueue) {
        this.sharedQueue = sharedQueue;
    }
...
public class ProducerConsumerWaitNotify {
    ...
    public static void main(String args[]) {
       ...
       ProducerT producer=new ProducerT(sharedQueue);
       ConsumerT consumer=new ConsumerT(sharedQueue);
